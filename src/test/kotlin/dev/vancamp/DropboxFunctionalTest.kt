...
class DropboxFunctionalTest {
    ...
    private fun getFile(key: String) = dropbox(Request(GET, "/$key"))
    private fun listFiles() = dropbox(Request(GET, "/"))
    private fun deleteFile(key: String) = dropbox(Request(POST, "/$key/delete"))
